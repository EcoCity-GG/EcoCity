...
import { CalendarDays, Clock, MapPin, SearchIcon, User, Lock } from 'lucide-react';
...
export function EventList() {
  ...
  // Se o usuário não está logado, mostra mensagem de login necessário
  if (!user) {
    return (
      <Card className="p-8 text-center">
        <CardContent className="pt-6">
          ...
          <p className="text-muted-foreground mb-4">
            Você precisa fazer login para visualizar os eventos ecológicos.
          </p>
          <Button onClick={() => navigate('/login')} className="bg-eco-green hover:bg-eco-green-dark">
            Fazer Login
          </Button>
        </CardContent>
      </Card>
